...
public class SuperWheatCommand implements CommandExecutor {
	...
	public boolean onCommand (CommandSender sender, Command command, String commandLabel, String[] args) {
		if (args.length == 0) sender.sendMessage(ChatColor.YELLOW + "Usage: /superwheat reload (or /sw reload)");
			...
			else sender.sendMessage(ChatColor.RED + "You don't have the permission to reload SuperWheat!");
		}
		else sender.sendMessage(ChatColor.RED + "This argument is unkown!");
		return true;
	}
}